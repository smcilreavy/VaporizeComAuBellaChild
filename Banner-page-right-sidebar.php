...
/* Template Name:Banner with Right Sidebar */
	...
	<div id="spacer" class="container">
		<div class="row">       
            <div class="col-md-9 content" id="content">                           
                ...
                <?php endif; ?>
<?php (basename(get_permalink()) == 'advocacy' ? comments_template( 'comments.php' ) : ''); ?>
            </div>
           
                    <aside class="col-md-3 sidebar" id="sidebar">             
                        <?php if (is_active_sidebar('bella-widgets-aside-right')) dynamic_sidebar('bella-widgets-aside-right'); ?>          
                    </aside>                        
