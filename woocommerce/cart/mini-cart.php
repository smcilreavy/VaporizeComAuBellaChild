...
<ul class="cart_list product_list_widget <?php echo $args['list_class']; ?>">
	...
	<?php else : ?>
		...
		<li class="empty"><?php _e( 'ER No products in the cart.', 'woocommerce' ); ?></li>
...
<?php if ( sizeof( WC()->cart->get_cart() ) > 0 ) : ?>
	...
	<p class="buttons">
		<a href="<?php echo WC()->cart->get_cart_url(); ?>" class="button wc-forward"><?php _e( 'ER View Cart', 'woocommerce' ); ?></a>
