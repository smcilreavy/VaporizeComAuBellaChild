...
<link rel="shortcut icon" href="http://vaporize.staging.wpengine.com/wp-content/themes/bella-installable/style.css?ver=4.2.2">
...
jQuery(function(){
    ...
    /**
     * new code by Alex Zappa a.k.a. reatlat
     */
    ...
    /* end code by reatlat */
	jQuery(".product-rating .add-review").click(function(){
...
<body id="home" <?php body_class($layout.$class); ?>>
...
if($breadcrumb==1 && is_page_template('bella-page-builder-simple-header.php') ):
	$breadcrumb=0;
endif;
